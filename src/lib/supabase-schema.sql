...
('a1000000-0000-0000-0000-000000000001', 'Entrées', 'entrees', 'Mises en bouche raffinées et salades gourmandes', 'Salad', 1),
('a1000000-0000-0000-0000-000000000002', 'Plats', 'plats', 'Nos créations signatures et spécialités du Chef', 'ChefHat', 2),
('a1000000-0000-0000-0000-000000000003', 'Burgers', 'burgers', 'Burgers gourmets avec pains artisanaux et viandes sélectionnées', 'Beef', 3),
('a1000000-0000-0000-0000-000000000004', 'Pizzas', 'pizzas', 'Pizzas au feu de bois pâte fine et mozzarella di bufala', 'Pizza', 4),
('a1000000-0000-0000-0000-000000000005', 'Pâtes', 'pates', 'Pâtes fraîches maison aux sauces onctueuses', 'Soup', 5),
('a1000000-0000-0000-0000-000000000006', 'Poulet', 'poulet', 'Volailles fermières rôties, marinées et braisées', 'Egg', 6),
('a1000000-0000-0000-0000-000000000007', 'Viandes', 'viandes', 'Pièces de bœuf et zébu d''exception maturies', 'Flame', 7),
('a1000000-0000-0000-0000-000000000008', 'Poissons', 'poissons', 'Poissons nobles et crustacés de nos côtes', 'Fish', 8),
('a1000000-0000-0000-0000-000000000009', 'Boissons', 'boissons', 'Cocktails signatures, vins fins et jus pressés', 'Wine', 9),
('a1000000-0000-0000-0000-000000000010', 'Desserts', 'desserts', 'Douceurs sucrées de notre Maître Pâtissier', 'IceCream', 10)
...
-- Burgers
('b1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000003', 'Burger Royal Signature', 'Steak haché de zébu 200g, cheddar affiné, oignons caramélisés au miel, salade croquante et sauce truffée maison dans un pain brioché artisanal.', 35000.00, 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&w=800&q=80', true, true, true, 20, 780),
('b1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000003', 'Smoky Bacon & Truffle Burger', 'Double smash patty de bœuf, bacon croustillant, raclette fondue, roquette et mayonnaise fumée au poivre sauvage.', 38000.00, 'https://images.unsplash.com/photo-1586190848861-99aa4a171e90?auto=format&fit=crop&w=800&q=80', true, false, true, 18, 850),

-- Viandes
('b1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000007', 'Filet de Zébu au Poivre Vert de Madagascar', 'Cœur de filet tendre saisi minute, réduction crémée au poivre vert frais de Manakara, écrasé de pommes de terre à l''huile de truffe.', 48000.00, 'https://images.unsplash.com/photo-1558030006-450675393462?auto=format&fit=crop&w=800&q=80', true, true, true, 25, 620),
('b1000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000007', 'Côte de Bœuf Grillée au Thym (Pour 2)', 'Côte maturée 30 jours (800g) grillée aux sarments de vigne, beurre maître d''hôtel et légumes glacés de saison.', 95000.00, 'https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=800&q=80', true, false, false, 30, 1100),

-- Poissons
('b1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000008', 'Camarons Géants Flambés au Rhum', 'Gambas royales de Mahajanga saisies à la plancha, flambées au rhum ambré, émulsion citronnelle et riz parfumé au combava.', 55000.00, 'https://images.unsplash.com/photo-1565680018434-b513d5e5fd47?auto=format&fit=crop&w=800&q=80', true, true, true, 22, 510),
('b1000000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000008', 'Pavé de Saumon Sauvage Rôti', 'Saumon croustillant sur peau, mousseline de patates douces vanillées et beurre blanc à l''aneth.', 46000.00, 'https://images.unsplash.com/photo-1467003909585-2f8a72700288?auto=format&fit=crop&w=800&q=80', true, false, false, 20, 540),

-- Poulet
('b1000000-0000-0000-0000-000000000007', 'a1000000-0000-0000-0000-000000000006', 'Suprême de Volaille Fermière au Curry Coco', 'Suprême doré au four, sauce crémeuse lait de coco et épices douces, mangue rôtie et riz basmati aux amandes.', 36000.00, 'https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?auto=format&fit=crop&w=800&q=80', true, false, true, 20, 590),
('b1000000-0000-0000-0000-000000000008', 'a1000000-0000-0000-0000-000000000006', 'Brochettes de Poulet Yakitori Laquées', 'Dés de cuisse marinés au gingembre et soja doux, graines de sésame grillées et salade d''algues wakame.', 28000.00, 'https://images.unsplash.com/photo-1527477396000-e27163b481c2?auto=format&fit=crop&w=800&q=80', true, false, false, 15, 450),

-- Pizzas
('b1000000-0000-0000-0000-000000000009', 'a1000000-0000-0000-0000-000000000004', 'Pizza Truffe & Burrata Crémeuse', 'Crème de truffe blanche, fior di latte, véritable burrata des Pouilles posée à cru, copeaux de parmesan 24 mois et roquette.', 42000.00, 'https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&w=800&q=80', true, true, true, 15, 820),
('b1000000-0000-0000-0000-000000000010', 'a1000000-0000-0000-0000-000000000004', 'Pizza Reine di Parma', 'Coulis de tomates San Marzano, mozzarella fraîche, jambon de Parme affiné 18 mois, champignons de Paris frais et basilic.', 34000.00, 'https://images.unsplash.com/photo-1604382355076-af4b0eb60143?auto=format&fit=crop&w=800&q=80', true, false, false, 15, 760),

-- Pâtes
('b1000000-0000-0000-0000-000000000011', 'a1000000-0000-0000-0000-000000000005', 'Tagliatelles Fraîches aux Fruits de Mer', 'Pâtes artisanales maison, calamars, moules, crevettes sautées à l''ail doux, vin blanc et bisque de homard.', 44000.00, 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?auto=format&fit=crop&w=800&q=80', true, false, true, 18, 640),
('b1000000-0000-0000-0000-000000000012', 'a1000000-0000-0000-0000-000000000005', 'Ravioles Maison Ricotta & Épinards', 'Ravioles confectionnées le jour même, crème légère de parmesan et noisettes torréfiées concassées.', 32000.00, 'https://images.unsplash.com/photo-1551183053-bf91a1d81141?auto=format&fit=crop&w=800&q=80', true, false, false, 15, 520),

-- Entrées
('b1000000-0000-0000-0000-000000000013', 'a1000000-0000-0000-0000-000000000001', 'Carpaccio de Zébu aux Baies Roses', 'Fines tranches de zébu mariné à l''huile d''olive vierge extra, copeaux de pecorino, baies roses et câpres.', 24000.00, 'https://images.unsplash.com/photo-1541544741938-0af808871cc0?auto=format&fit=crop&w=800&q=80', true, false, true, 10, 310),
('b1000000-0000-0000-0000-000000000014', 'a1000000-0000-0000-0000-000000000001', 'Foie Gras Poêlé sur Pain d''Épices', 'Escalope de foie gras de canard mi-cuit, chutney de mangue épicée et réduction de vin de porto.', 38000.00, 'https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=800&q=80', true, true, false, 12, 490),

-- Desserts
('b1000000-0000-0000-0000-000000000015', 'a1000000-0000-0000-0000-000000000010', 'Dôme Chocolat Grand Cru Sambirano', 'Chocolat noir 70% pure origine Madagascar, cœur coulant praliné feuillantine et glace artisanale à la vanille Bourbon.', 22000.00, 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?auto=format&fit=crop&w=800&q=80', true, true, true, 10, 480),
